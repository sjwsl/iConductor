...
class initFrame(wx.Frame):
    ...
    def __init__(self, parent=None, fid=-1):
        ...
        self.coords = multiprocessing.Manager().dict()
        self.paras = multiprocessing.Manager().list()
        ...
        list_1 = [' 140 cm', ' 150 cm', ' 160 cm', ' 170 cm', ' 180 cm', ' 190 cm', ' 200 cm']
        ...
        self.btn_1 = wx.Button(self, id=-1, label='63', pos=(625, 236), size=(28, 28))
        self.btn_1.Bind(wx.EVT_LEFT_DOWN, self.sld)
        self.btn_2 = wx.Button(self, id=-1, label='×', pos=(664, 236), size=(26, 28))
        ...
        wx.StaticLine(self, pos=(60, 360), size=(260, -1), style=wx.SL_HORIZONTAL)
        ...
        self.gau_2 = wx.Gauge(self, -1, 127, pos=(440, 337), size=(250, 20), style=wx.GA_SMOOTH)
    ...
    def up_or_dn(self):
        ...
        if self.instr_ > 0:
            if self.btn_5 is None:
                self.btn_5 = wx.Button(self, id=-1, label='up', pos=(60, 320), size=(20, 20))
        ...
        if tot > self.instr_ + 6:
            if self.btn_6 is None:
                self.btn_6 = wx.Button(self, id=-1, label='dn', pos=(100, 320), size=(20, 20))
    ...
    def add(self, event):
        ...
        self.grp_s.append(wx.StaticText(self, len(self.grp_s), label=grp, pos=(620, 405), size=(60, 20)))
    ...
    def rmv(self, event):
        ...
        if num == 0:
            ...
            for i in range(idx, num + 1):
                self.volume[str(i) + '_' + ins] = self.volume[str(i + 1) + '_' + ins]
